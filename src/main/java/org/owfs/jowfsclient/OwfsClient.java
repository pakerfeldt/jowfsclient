...
public interface OwfsClient {
	 ...
	 * 
	 * @param deviceDisplay
	 *            the new {@link OwDeviceDisplayFormat}.
	 */
	 ...
	 * 
	 * @param tempScale
	 *            the new {@link OwTemperatureScale} value.
	 */
	 ...
	 * 
	 * @param persistence
	 *            the new {@link OwPersistence} value
	 */
	 ...
	 * 
	 * @param busReturn
	 *            the new {@link OwBusReturn} value.
	 */
	 ...
	 *             if an I/O error occurs.
	 * @throws OwfsException
	 *             if the value couldn't be written and if owserver returns an
	 *             error.
	 */
	void write(String path, String dataToWrite) throws IOException,
			OwfsException;
	 ...
	 * 
	 * @param path
	 *            the path/entity to check for existence.
	 ...
	 * 
	 * @param path
	 *            the path to list elements from
	 * @return a {@code List}<String> of elements found inside the specified
	 *         path.
	 * @throws OwfsException
	 *             if owserver returns an error.
	 * @throws IOException
	 *             if an I/O error occurs.
	 */
	List<String> listDirectoryAll(String path) throws OwfsException,
			IOException;
